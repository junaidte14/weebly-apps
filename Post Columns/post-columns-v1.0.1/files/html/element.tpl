{{! template for the Post Columns.}}
<div class="codo-post-columns">
	<p>This section will not be visible in live published website. Below are your current settings (click inside this section to edit the settings): 
